---
title: UsefulCarts
description: Decorative and functional pull-along carts — an MIT port of jmb05's NiftyCarts.
---

A collection of decorative and functional carts you attach to a mob with a lead (or pull yourself) to haul goods, move animals, and work your fields. UsefulCarts is an **MIT-licensed port of jmb05's NiftyCarts** to modern Minecraft, with original work by **MennoMax** and **jmb05**.
...
- [GitHub — 26.2](https://github.com/Andrewwwwwwwwwwwwwww/usefulcarts) · [GitHub — 26.1.2](https://github.com/Andrewwwwwwwwwwwwwww/usefulcarts-mc26.1.2)
